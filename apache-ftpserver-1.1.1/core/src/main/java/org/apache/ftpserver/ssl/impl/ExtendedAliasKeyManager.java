...
public final class ExtendedAliasKeyManager extends X509ExtendedKeyManager {
	 ...
	 * @param issuers The list of acceptable CA issuer subject names, or null if it
	 *                does not matter which issuers are used
	 * @param socket  The socket to be used for this connection. This parameter can
	 ...
	 * @param issuers The list of acceptable CA issuer subject names, or null if it
	 *                does not matter which issuers are used (ignored)
	 * @param engine  The engine to be used for this connection.
	 * @return The alias name for the desired key, or null if there are no
	 * matches
	 */
	@Override
