...
public class ListenerBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
	...
	protected void doParse(final Element element, final ParserContext parserContext, final BeanDefinitionBuilder builder) {
		...
		if (blacklistElm != null) {
			LOG.warn("Element 'blacklist' is deprecated, and may be removed in a future release. Please use 'remote-ip-filter' instead. ");
			try {
		...
		Element remoteIpFilterElement = SpringUtil.getChildElement(element, FtpServerNamespaceHandler.FTPSERVER_NS, "remote-ip-filter");
