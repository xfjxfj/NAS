...
public class LocalizedRenameFtpReply extends LocalizedFtpReply implements RenameFtpReply {
	 ...
	 * @param from     the file or directory as it was before the rename
	 * @param to       the file or directory after the rename
	 * @return the localized reply
	 */
	public static LocalizedRenameFtpReply translate(FtpIoSession session, FtpRequest request, FtpServerContext context, int code, String subId, String basicMsg, FtpFile from, FtpFile to) {
