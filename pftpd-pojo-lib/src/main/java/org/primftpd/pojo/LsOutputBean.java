...
public class LsOutputBean {
	...
	public LsOutputBean(boolean isFile, boolean isDir, boolean isLink, boolean userReadable, boolean userWritable, boolean userExecutable, boolean groupReadable, boolean groupWritable, boolean groupExecutable, boolean otherReadable, boolean otherWritable, boolean otherExecutable, boolean hasAcl, long linkCount, long size, Date date, String user, String group, String name, String linkTarget) {
		this.exists = true;
		this.isFile = isFile;
		this.isDir = isDir;
		this.isLink = isLink;
