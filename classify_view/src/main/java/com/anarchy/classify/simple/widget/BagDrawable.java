...
class BagDrawable extends Drawable {
	...
	private final int mSavedOutlinePadding;
...
//    private float[] mPositions = new float[]{0f,0.11f,0.11f,0.125f,0.14f,0.14f,0.61f,0.61f,0.625f,0.64f,0.64f,1f};
	private final int mCenterColor = 0xFFFFFFFF;
	private final int mEdgeColor = 0xFF808080;
...
//            mPaint.setShader(new SweepGradient(mRectF.centerX(),mRectF.centerY(),mColors,mPositions));
	...
	private final Property<BagDrawable, Integer> mOutlineProperty = new Property<BagDrawable, Integer>(Integer.class, "outline") {
		@Override
