...
public class PathConfig {
	...
	private static final String NAS = PathUtils.getExternalStoragePath() + File.separator + "nas" + File.separator;

	//引导资源目录
	public static final String GUIDE_RESOURCE = NAS + "guideResource" + File.separator;

	//私有空间目录
	private static final String PRIVATE = NAS + "private" + File.separator;

	//公共空间目录
	private static final String PUBLIC = NAS + "public" + File.separator;
