...
public class IotGateway {
    ...
    public static boolean executeModel(String modelName) {
        ...
        if (modelArrObj != null) {
            ...
            //Cache中查找
            if (modelArr == null || modelArr.size() == 0)
                return false;
    ...
    public static boolean executeDevice(String deviceName, String area, String status) {
        ...
        if (modelArrObj != null) {
            ...
            for (int i = 0; i < deviceArr.size(); i++) {
                ...
                if (deviceName.equalsIgnoreCase(device.getString("label")) && (areaDeviceUids == null || areaDeviceUids.contains(device.getString("UID")))) {
    ...
    public static void uploadAreaEntity(AIUIAgent mAIUIAgent) throws UnsupportedEncodingException {
        ...
        syncSchemaJson.put("data", Base64.encodeToString(sb.toString().getBytes("UTF-8"), Base64.DEFAULT | Base64.NO_WRAP));
