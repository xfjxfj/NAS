...
//		FileWatcher fileWatcher = new FileWatcher(PathConfig.NAS, true, FileWatcher.ALL_EVENTS);
//		fileWatcher.setFileListener(new FileListener() {
//			@Override
//			public void onFileAccess(String name) {
//
//			}
//
//			@Override
//			public void onFileOpen(String name) {
//
//			}
//
//			@Override
...
//		FileObserverJni fileObserverJni = new FileObserverJni(PathConfig.NAS, FileObserverJni.ALL_EVENTS);
//		fileObserverJni.setmCallback((path, mask) -> {
//			switch (mask) {
//				case FileObserverJni.ACCESS:
//					LogUtils.iTag("FileObserverJni", "ACCESS: " + path);
//					break;
//
//				case FileObserverJni.MODIFY:
//					LogUtils.iTag("FileObserverJni", "MODIFY: " + path);
//					break;
//
//				case FileObserverJni.ATTRIB:
//					LogUtils.iTag("FileObserverJni", "ATTRIB: " + path);
//					break;
//
//				case FileObserverJni.CLOSE_WRITE:
//					LogUtils.iTag("FileObserverJni", "CLOSE_WRITE: " + path);
//					break;
//
//				case FileObserverJni.CLOSE_NOWRITE:
//					LogUtils.iTag("FileObserverJni", "CLOSE_NOWRITE: " + path);
//					break;
//
//				case FileObserverJni.OPEN:
//					LogUtils.iTag("FileObserverJni", "OPEN: " + path);
//					break;
//
//				case FileObserverJni.MOVED_FROM:
//					LogUtils.iTag("FileObserverJni", "MOVED_FROM: " + path);
//					break;
//
//				case FileObserverJni.MOVED_TO:
//					LogUtils.iTag("FileObserverJni", "MOVED_TO: " + path);
//					break;
//
//				case FileObserverJni.CREATE:
//					LogUtils.iTag("FileObserverJni", "CREATE: " + path);
//					break;
//
//				case FileObserverJni.DELETE:
//					LogUtils.iTag("FileObserverJni", "DELETE: " + path);
//					break;
//
//				case FileObserverJni.DELETE_SELF:
//					LogUtils.iTag("FileObserverJni", "DELETE_SELF: " + path);
//					break;
//
//				case FileObserverJni.MOVE_SELF:
//					LogUtils.iTag("FileObserverJni", "MOVE_SELF: " + path);
//					break;
//
//				default:
//					LogUtils.iTag("FileObserverJni", "UNKNOWN: " + path);
//					break;
//			}
//		});
	}
