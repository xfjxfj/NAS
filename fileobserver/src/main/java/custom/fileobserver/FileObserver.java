...
public abstract class FileObserver {
	...
	private static class ObserverThread extends Thread {
		private final HashMap<Integer, WeakReference<Object>> mObservers = new HashMap<Integer, WeakReference<Object>>();
		private final HashMap<Integer, String> mListPath = new HashMap<Integer, String>();
		private final FolderFilter mFilter = new FolderFilter();
	...
	private final boolean mWatchSubDir;
