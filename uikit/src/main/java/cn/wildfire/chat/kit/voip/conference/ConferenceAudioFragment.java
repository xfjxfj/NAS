...
public class ConferenceAudioFragment extends Fragment implements AVEngineKit.CallSessionCallback {
	@BindView(R2.id.durationTextView) TextView durationTextView;
	@BindView(R2.id.audioContainerGridLayout) GridLayout participantGridView;

	@BindView(R2.id.focusAudioContainerFrameLayout) FrameLayout focusAudioContainerFrameLayout;

	@BindView(R2.id.speakerImageView) ImageView speakerImageView;
	@BindView(R2.id.muteImageView) ImageView muteImageView;
