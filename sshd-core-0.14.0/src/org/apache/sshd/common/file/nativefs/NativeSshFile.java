...
public class NativeSshFile implements SshFile {
	 ...
	 */
	protected NativeSshFile(final NativeFileSystemView nativeFileSystemView, final String fileName, final File file, final String userName) {
...
//        }
		...
		NativeSshFile parentObject = nativeFileSystemView.createNativeSshFile(parentFullName, file.getAbsoluteFile().getParentFile(), userName);
	...
	public SshFile getParentFile() {
		...
		// we check if the parent FileObject is writable.
		return nativeFileSystemView.createNativeSshFile(parentFullName, file.getAbsoluteFile().getParentFile(), userName);
	}
