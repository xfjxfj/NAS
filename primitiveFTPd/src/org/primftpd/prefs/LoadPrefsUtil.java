...
public class LoadPrefsUtil {
	...
	public static Boolean anonymousLogin(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_ANONYMOUS_LOGIN, Boolean.FALSE);
	}

	public static String userName(SharedPreferences prefs) {
		return prefs.getString(LoadPrefsUtil.PREF_KEY_USER, "admin");
	}
	...
	public static Boolean announce(SharedPreferences prefs) {
		...
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_ANNOUNCE, Boolean.FALSE);
	}

	public static String announceName(SharedPreferences prefs) {
		return prefs.getString(LoadPrefsUtil.PREF_KEY_ANNOUNCE_NAME, "primitive ftpd");
	}

	public static Boolean wakelock(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_WAKELOCK, Boolean.TRUE);
	}

	public static Boolean startOnBoot(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_START_ON_BOOT, Boolean.FALSE);
	}

	public static Boolean startOnOpen(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_START_ON_OPEN, Boolean.FALSE);
	}

	public static Boolean showStartStopNotification(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_SHOW_START_STOP_NOTIFICATION, Boolean.FALSE);
	}

	public static Boolean showConnectionInfoInNotification(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_SHOW_CONN_INFO, Boolean.TRUE);
	}

	public static Boolean showIpv4InNotification(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_SHOW_IPV4, Boolean.TRUE);
	}

	public static Boolean showIpv6InNotification(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_SHOW_IPV6, Boolean.TRUE);
	}

	public static Boolean pubKeyAuth(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_KEY_PUB_KEY_AUTH, Boolean.FALSE);
	}

	public static ServerToStart serverToStart(SharedPreferences prefs) {
		String whichServerStr = prefs.getString(LoadPrefsUtil.PREF_KEY_WHICH_SERVER, ServerToStart.ALL.xmlValue());
		return ServerToStart.byXmlVal(whichServerStr);
	}

	public static Theme theme(SharedPreferences prefs) {
		String themeStr = prefs.getString(PREF_KEY_THEME, Theme.DARK.xmlValue());
	...
	public static String ftpPassivePorts(SharedPreferences prefs) {
		...
		String prefVal = prefs.getString(LoadPrefsUtil.PREF_KEY_FTP_PASSIVE_PORTS, PORT_PASSIVE_DEFAULT_VAL_STR);
	...
	public static StorageType storageType(SharedPreferences prefs) {
		String storageTypeStr = prefs.getString(PREF_KEY_STORAGE_TYPE, StorageType.PLAIN.xmlValue());
	...
	public static String safUrl(SharedPreferences prefs) {
		return prefs.getString(LoadPrefsUtil.PREF_KEY_SAF_URL, "");
	}
	...
	public static String allowedIpsPattern(SharedPreferences prefs) {
		return prefs.getString(LoadPrefsUtil.PREF_KEY_ALLOWED_IPS_PATTERN, "");
	}

	public static int loadPortInsecure(Logger logger, SharedPreferences prefs) {
		return loadPort(logger, prefs, PREF_KEY_PORT, PORT_DEFAULT_VAL, PORT_DEFAULT_VAL_STR);
	}

	public static int loadPortSecure(Logger logger, SharedPreferences prefs) {
		return loadPort(logger, prefs, PREF_KEY_SECURE_PORT, SECURE_PORT_DEFAULT_VAL, SECURE_PORT_DEFAULT_VAL_STR);
	}

	static int loadPort(Logger logger, SharedPreferences prefs, String prefsKey, int defaultVal, String defaultValStr) {
		// load port
		int port = defaultVal;
	...
	public static Boolean quickSettingsRequiresUnlock(SharedPreferences prefs) {
		return prefs.getBoolean(LoadPrefsUtil.PREF_QUICK_SETTINGS_REQUIRES_UNLOCK, Boolean.TRUE);
	}
