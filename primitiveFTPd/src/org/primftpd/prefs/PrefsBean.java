...
public class PrefsBean implements Serializable {
	...
	public PrefsBean(String userName, String password, boolean anonymousLogin, int port, int securePort, File startDir, boolean announce, String announceName, boolean wakelock, boolean pubKeyAuth, ServerToStart serverToStart, String ftpPassivePorts, Integer idleTimeout, boolean showConnectionInfoInNotification, StorageType storageType, String safUrl, String allowedIpsPattern) {
		super();
