...
public abstract class PowerTogglesPlugin extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		if (ACTION_SET_STATE.equals(intent.getAction())) {
			changeState(context, intent.getBooleanExtra(EXTRA_STATE, false), intent.getStringExtra(Intent.EXTRA_UID));
		}
	}
	 ...
	 * @param context
	 */
	public static final void sendStateUpdate(Class<? extends PowerTogglesPlugin> pluginClass, boolean newState, Context context) {
	 ...
	 * @param context
	 */
	public static final void sendStateUpdate(Class<? extends PowerTogglesPlugin> pluginClass, boolean newState, String id, Context context) {
		context.sendBroadcast(new Intent(ACTION_STATE_CHANGED).putExtra(EXTRA_VARID, pluginClass.getName())
