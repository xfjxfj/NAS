...
public abstract class RoSafFileSystemView<T extends RoSafFile<X>, X> {
	...
	protected abstract T createFile(ContentResolver contentResolver, Uri startUrl, String absPath, PftpdService pftpdService);

	protected abstract T createFile(ContentResolver contentResolver, Uri startUrl, String docId, String absPath, PftpdService pftpdService);

	protected abstract T createFileNonExistant(ContentResolver contentResolver, Uri startUrl, String name, String absPath, PftpdService pftpdService);
	...
	public T getFile(String file) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			for (int i = 0; i < parts.size(); i++) {
				...
				Uri childrenUri = DocumentsContract.buildChildDocumentsUriUsingTree(startUrl, parentId);
