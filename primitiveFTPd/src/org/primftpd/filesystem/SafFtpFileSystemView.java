...
public class SafFtpFileSystemView extends SafFileSystemView<SafFtpFile, FtpFile> implements FileSystemView {
	...
	@Override
	protected SafFtpFile createFile(ContentResolver contentResolver, DocumentFile parentDocumentFile, DocumentFile documentFile, String absPath, PftpdService pftpdService) {
	...
	@Override
	protected SafFtpFile createFile(ContentResolver contentResolver, DocumentFile parentDocumentFile, String name, String absPath, PftpdService pftpdService) {
