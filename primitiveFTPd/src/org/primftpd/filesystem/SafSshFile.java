...
public class SafSshFile extends SafFile<SshFile> implements SshFile {
	...
	public SafSshFile(ContentResolver contentResolver, DocumentFile parentDocumentFile, DocumentFile documentFile, String absPath, PftpdService pftpdService, Session session, SafSshFileSystemView fileSystemView) {
		super(contentResolver, parentDocumentFile, documentFile, absPath, pftpdService);
		this.session = session;
		this.fileSystemView = fileSystemView;
	}

	public SafSshFile(ContentResolver contentResolver, DocumentFile parentDocumentFile, String name, String absPath, PftpdService pftpdService, Session session, SafSshFileSystemView fileSystemView) {
	...
	@Override
	protected SshFile createFile(ContentResolver contentResolver, DocumentFile parentDocumentFile, DocumentFile documentFile, String absPath, PftpdService pftpdService) {
