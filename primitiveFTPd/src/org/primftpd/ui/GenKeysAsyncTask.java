...
public class GenKeysAsyncTask extends AsyncTask<Void, Void, Void> {
	...
	public GenKeysAsyncTask(KeyFingerprintProvider keyFingerprintProvider, PrimitiveFtpdActivity activity, ProgressDialog progressDiag, boolean startServerOnFinish) {
