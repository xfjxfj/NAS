...
public class KeyInfoProvider {
	...
	public PublicKey readPublicKey(FileInputStream fis) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException {
	...
	public PrivateKey readPrivatekey(FileInputStream fis) throws NoSuchAlgorithmException, InvalidKeySpecException, IOException {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		IoUtils.copy(fis, baos, BUFFER_SIZE);
	...
	public byte[] encodeAsSsh(RSAPublicKey pubKey) throws IOException {
	...
	private void writeKeyPart(byte[] bytes, OutputStream os) throws IOException {
