...
public abstract class AbstractServerService extends Service implements PftpdService {
	...
	protected abstract ServerServiceHandler createServiceHandler(Looper serviceLooper, AbstractServerService service);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		keyFingerprintProvider = (KeyFingerprintProvider) extras.get(ServicesStartStopUtil.EXTRA_FINGERPRINT_PROVIDER);
	...
	@Override
	public void postClientAction(ClientActionEvent.Storage storage, ClientActionEvent.ClientAction clientAction, String clientIp, String path) {
		ClientActionEvent event = new ClientActionEvent(storage, getProtocol(), clientAction, new Date(), clientIp, path);
